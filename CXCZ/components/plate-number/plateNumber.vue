		...
		<view class="plate-popup" v-show="plateShow">
			...
			<view v-show="type">
				<view class="plate-popup-item">
					<view class="plate-popup-item-list" v-for="item in keyVehicle1" @click="plateHead(item)">{{item}}
					</view>
				</view>
				<view class="plate-popup-item">
					<view class="plate-popup-item-list" v-for="item in keyVehicle2" @click="plateHead(item)">{{item}}
					</view>
				</view>
				<view class="plate-popup-item">
					<view class="plate-popup-item-list" v-for="item in keyVehicle3" @click="plateHead(item)">{{item}}
					</view>
				</view>
				<view class="plate-popup-item">
					<view class="plate-popup-item-list" v-for="item in keyVehicle4" @click="plateHead(item)">{{item}}
					</view>
					<!-- 删除 -->
			...
			<view v-show="!type">
				<view class="plate-popup-item">
					<!-- 数字选择 -->
					<view class="plate-popup-item-list" :class="(plateNumber.length<2 || isInputZh)?'':''"
						v-for="item in keyNumber" @click="plateNum(item)">{{item}}</view>
